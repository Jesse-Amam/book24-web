...
class Confirm extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  render() {
    return __jsx("div", null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_0___default.a, null, __jsx("meta", {
      ...
      className: "container"
    }, __jsx("h1", null, "Booking"))), __jsx("main", null, __jsx("div", {
      ...
      className: "icon icon--order-success svg add_bottom_15"
    }, __jsx("svg", {
    ...
    })))), __jsx("h2", null, "Booking Confirmed!"), __jsx("p", null, "Sit an meis aliquam, cetero inermis."))))), __jsx("div", {
    ...
    }), __jsx("h4", null, "Need Help? Contact us"), __jsx("p", null, "Cum appareat maiestatis interpretaris et, et sit."))), __jsx("div", {
      className: "col-lg-4"
    }, __jsx("a", {
      href: "#0",
      className: "boxed_list"
    ...
    }), __jsx("h4", null, "Payments"), __jsx("p", null, "Qui ea nemore eruditi, magna prima possit eu mei."))), __jsx("div", {
      className: "col-lg-4"
    }, __jsx("a", {
      href: "#0",
      className: "boxed_list"
    ...
    }), __jsx("h4", null, "Cancel Policy"), __jsx("p", null, "Hinc vituperata sed ut, pro laudem nonumes ex."))))))), __jsx(_components_footer__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], null)), __jsx(_components_signInModal__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], null), __jsx("div", {
      id: "toTop"
    }), __jsx("script", {
